...
// Props: Paciente a editar y modo edición
...
// Estado local del Paciente (clonado desde las props)
...
function guardar() {
  emit('guardar', Paciente.value); // Emitir el Paciente actualizado al padre
}
</script>
