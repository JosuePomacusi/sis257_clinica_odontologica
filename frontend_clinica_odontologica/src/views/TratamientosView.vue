...
import { ref } from 'vue'
import TratamientoList from '../components/tratamientos/TratamientoList.vue'
import TratamientoSave from '../components/tratamientos/TratamientoSave.vue'

const mostrarDialog = ref<boolean>(false)
const TratamientoListRef = ref<typeof TratamientoList | null>(null)
const tratamientoEdit = ref<any>(null)

function handleCreate() {
  tratamientoEdit.value = null
  mostrarDialog.value = true
}

function handleEdit(tratamiento: any) {
  tratamientoEdit.value = tratamiento
  mostrarDialog.value = true
}
